// Map tweets with Backbone.js
$(function() {
  var geocoder = new google.maps.Geocoder();
  var Tweet = Backbone.Model;

  //Start the searching once the user clicks search button
  $('search_button').click(function() {

    var customURL = "https://api.twitter.com/1.1/search/tweets.json?" +
      "q=search_term_here&" +
      "result_type=recent&" +
    ...
    var Tweets = Backbone.Collection.extend({
      ...
      parse: function(response) {
        var filtered = _.filter(response.statuses, function(tweet) {
          return tweet.user.location !== null
        });
        this.add(filtered);
      },
